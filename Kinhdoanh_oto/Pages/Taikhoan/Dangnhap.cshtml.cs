...
<<<<<<< HEAD
=======
        public async Task<IActionResult> OnPostAsync(string sodienthoai, string matkhau)
        {
...
=======
                    var email = decoded.Claims.ContainsKey("email") ? decoded.Claims["email"].ToString() : string.Empty;
                    var name = decoded.Claims.ContainsKey("name") ? decoded.Claims["name"].ToString() : email;
